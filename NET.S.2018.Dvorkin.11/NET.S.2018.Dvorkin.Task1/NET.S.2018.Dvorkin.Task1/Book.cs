...
namespace NET.S._2018.Dvorkin.Task1
{
    ...
    /// <seealso cref="System.IComparable{NET.S._2018.Dvorkin.Task1.Book}" />
    /// <seealso cref="System.IEquatable{NET.S._2018.Dvorkin.Task1.Book}" />
    public class Book : IComparable, IComparable<Book>, IEquatable<Book>, IFormattable
    {
        /// <summary>
        /// The ISBN regex
        /// </summary>
        private readonly Regex isbnRegex = new Regex("^[0-9]{3}[-]{1}[0-9]{1}[-]{1}[0-9]{4}[-]{1}[0-9]{4}[-]{1}[0-9]{1}$");
        ...
        public Book(string isbn, string authorFirstName, string authorLastName, string title, string publisher, int yearPublish, int page, decimal price)
        {
            this.Isbn = isbn;
        ...
        public string Isbn
        {
            ...
            set
            {
                if (this.isbnRegex.IsMatch(value) == false)
                {
        ...
        public string AuthorFirstName
        {
            ...
            set
            {
                if (this.nameRegex.IsMatch(value) == false)
                {
                    throw new ArgumentException($"{nameof(value)} doesn't match the rules");
                }
