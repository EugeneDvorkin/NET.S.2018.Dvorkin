...
namespace BLL.Mappers
{
    ...
    public static class BllAccountMapper
    {
        ...
        {
            AccountDal temp = new AccountDal(accountBll.PersonId, accountBll.Number, accountBll.Balance,
        ...
        {
            return new AccountDal(accountBll.PersonId, accountBll.Number, accountBll.Balance,
                accountBll.Point, (int)accountBll.TypeId);
        }
