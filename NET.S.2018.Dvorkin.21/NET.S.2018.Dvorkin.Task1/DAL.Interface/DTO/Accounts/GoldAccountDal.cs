...
namespace DAL.Interface.DTO
{
    ...
    public class GoldAccountDal : AccountDal
    {
        ...
        public GoldAccountDal(int id, PersonalInfo personalInfo, int number, decimal balance, ICalculate calculate) : base(id, personalInfo, number, balance, 300, Type.Gold)
        {
