...
namespace NET.S._2018.Dvorkin.Task1
{
    ...
    public class Acc
    {
        ...
        public string Number
        {
            ...
            set
            {
                number = value ?? throw new ArgumentNullException($"{nameof(value)} is null");
            }
        }
        ...
        public string Name
        {
            ...
            set
            {
                name = value ?? throw new ArgumentNullException($"{nameof(value)} is null");
            }
        }
        ...
        public string Surname
        {
            ...
            set
            {
                surname = value ?? throw new ArgumentNullException($"{nameof(value)} is null");
            }
        }
